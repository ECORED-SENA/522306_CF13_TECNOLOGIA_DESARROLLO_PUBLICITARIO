export default {
  ...
  glosario: [
    ...
    },
    {
      termino: 'Usuario',
      significado:
        'persona que utiliza de forma habitual internet para sus rutinas diarias. Para las marcas determinados perfiles usuarios se pueden convertir en su público objetivo.',
    },
  ],
  complementario: [],
}
